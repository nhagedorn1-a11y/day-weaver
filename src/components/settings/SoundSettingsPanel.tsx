import { Volume2, VolumeX, ChevronRight, ChevronDown, Sparkles } from 'lucide-react';
...
export function SoundSettingsPanel({ onBack }: SoundSettingsPanelProps) {
  ...
  return (
    <div className="p-4">
      ...
      <p className="text-sm text-muted-foreground mb-6">Configure how phonetic sounds are spoken</p>
